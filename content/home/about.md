...
I am a data analyst with experience in gathering, organising, aggregating, transforming, analysing, and visualising data to uncover hidden patterns and trends. I would be competent in building, training, and evaluating predictive models for unseen data using Python, R, SQL, Tableau, Power BI, QlikView, Talend, Trifacta, OpenRefine in addition to basic knowledge of cloud solutions and big data frameworks for recognising critical business issues to make informed strategic data-driven decisions with actionable and meaningful insights.
