...
I am a data analyst with expertise in collecting, organizing, aggregating, transforming, analyzing, and visualizing data to find hidden patterns and trends. I would be capable of building, training, and evaluating predictive models for unseen data using Python, R, SQL, Tableau, Power BI, QlikView, Talend, Trifacta, OpenRefine in addition to basic familiarity with big data frameworks and cloud solutions to recognize critical business issues and make informed strategic data-driven decisions with valuable and actionable insights.
