...
I have in-depth experience on the quantitative field by gathering, managing, organizing, interpreting, aggregating, transformaing, analysing and exploring the data. Build, train and evaluate machine learning models using programming languages including Python, R, Excel, SQL and data visualization tools such as Tableau, Power BI etc…  
