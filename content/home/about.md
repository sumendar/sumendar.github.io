...
I am a data analyst with experience in gathering, organizing, aggregating, transforming, analyzing, interpreting, and visualizing data for extracting hidden patterns and trends. I can build, train, and evaluate predictive models using Python, R, SQL, Tableau, Power BI, Talend, Trifacta, and OpenRefine in addition to having basic knowledge of cloud platforms and big data analytical frameworks to identify critical business issues and make strategic data-driven decisions with actionable insights.
