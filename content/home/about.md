...
I am a data analyst with experience in gathering, organizing, aggregating, transforming, analyzing, and visualizing data. I can able to build, train, and evaluate predictive models using Python, R, SQL, Tableau, Power BI, Talend, Trifacta, and OpenRefine including basic familiarity with cloud and big data analytical frameworks in order to make strategic decisions based on actionable insights.
