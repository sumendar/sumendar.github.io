...
I am a data analyst with experience in gathering, organizing, aggregating, transforming, summarising, analyzing, interpreting, and visualizing data to identify hidden patterns. I can build, train, and evaluate predictive models, grouping unlabeled entities and finding associations using Python, R, SQL, Tableau, Power BI, Talend, Trifacta, and OpenRefine in addition to basic familiarity with cloud platforms and big data analytical frameworks to mitigate critical business issues to make strategic data-driven decisions based on actionable insights.
