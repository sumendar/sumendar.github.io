...
I am an experienced data analyst in the quantitative field by collects, organizes, aggregates transforms, analyzes, and visualizes the data. I can able to build, train, and evaluate predictive models using statistical skills such as Python, R, Excel, OpenRefine, Trifacta, Talend, and SQL, including business intelligence tools like Tableau, Power BI in addition to basic familiarity with cloud and big data analytical platforms…etc.
