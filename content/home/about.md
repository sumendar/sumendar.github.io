...
I am a data analyst with experience in gathering, organizing, aggregating, transforming, interpreting, analyzing, and visualizing data. I can able to build, train, and evaluate predictive models, plus pattern recognition using Python, R, SQL, Tableau, Power BI, Talend, Trifacta, and OpenRefine in addition to basic familiarity with cloud platforms and big data analytical frameworks which minimizes critical business issues and helps to make strategic data-driven decisions based on actionable insights.
