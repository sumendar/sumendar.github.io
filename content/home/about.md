...
I am a data analyst with experience in gathering, aggregating, transforming, interpreting, analysing, and visualising data to uncover hidden patterns and trends. I can also compete to build, train, evaluate, and tune predictive models for unseen data using Python, R, SQL, Tableau, Power BI, QlikView, Talend, Trifacta, and OpenRefine in addition to basic knowledge of cloud solutions and big data frameworks to recognise critical business issues which helps us to make strategic data-driven decisions with actionable and meaningful insights.
